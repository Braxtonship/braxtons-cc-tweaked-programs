--THIS IS A FILE MADE TO UPDATE OLD BACPAX INSTANCES TO THE NEW ONE
if not fs.exists("bacpax") then
    print("outdated file! updating to new bac package manager (renamed to bacpax)")
    ...
    print("complete!")
    print('try running "bacpax" instead of "bac".')
